...
import { leadSentence, llmsTxt } from '../../libs/llms-txt.mjs';
import { pageUrl } from '../../libs/site-url.mjs';

// /llms.txt, routed by middleware.js rather than by a next.config.js rewrite:
...
const fieldLinks = async (locale, labels) => {
