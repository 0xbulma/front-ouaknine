...
export const internalPath = (href: string | null | undefined): string | null => {
	...
	try {
		...
		const internal = url.hostname === "internal.invalid" || SITE_HOSTS.includes(url.hostname);
...
export const isSafeExternal = (href: string | null | undefined): boolean =>
