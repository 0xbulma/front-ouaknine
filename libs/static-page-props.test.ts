import { type PageResult, staticPageProps } from "./static-page-props";
...
const miss = (result: PageResult<unknown>) => ("notFound" in result ? result : null);
