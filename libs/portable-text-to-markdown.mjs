...
// The HTML counterpart is components/ui/rich-text.jsx; the two should agree on
...
const spanToMarkdown = (span, markDefs) => {
...
const isSpacer = block => blockText(block).trim() === '';

const listMarker = (block, index) =>
...
const renderBlock = block => {
  ...
  const heading = HEADINGS[block.style];
...
const renderImage = block => block.alt ?? block.caption ?? '';
