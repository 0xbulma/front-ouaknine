...
function deleteAllCookies(): void {
	for (const cookie of document.cookie.split(";")) {
		...
		// biome-ignore lint/suspicious/noDocumentCookie: the CookieStore API it prefers is not in Safari, and expiring a cookie is the one thing document.cookie does portably.
